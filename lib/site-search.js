...
export async function getSearchItems() {
  ...
  return [
    { title: 'Tip and discount calculator', description: 'Tip bill split sale discount tax final price savings', type: 'Guides', href: '/tools/tip-discount-calculator' },
    { title: 'Image format converter', description: 'Convert JPG JPEG PNG WebP images locally private browser tool', type: 'Guides', href: '/tools/jpg-to-png' },
