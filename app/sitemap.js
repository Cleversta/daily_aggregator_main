...
export default async function sitemap() {
  const staticRoutes = ['', '/about', '/editorial-policy', '/privacy', '/contact', '/topics', '/youtube', '/guide', '/creator-ideas', '/tools/calculator', '/tools/unit-converter', '/tools/color-picker', '/tools/christmas-countdown', '/tools/countdown'].map(
    (path) => ({
      url: `${BASE_URL}${path}`,
